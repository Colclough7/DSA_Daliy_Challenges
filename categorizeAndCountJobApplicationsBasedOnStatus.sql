...
Rejected: Applications where the candidate did not meet the necessary criteria for the role, including technical skills, company cultural fit, or other qualifications as determined by the hiring team.
Approved: Applications where the candidate successfully met or exceeded the evaluation criteria and are considered strong candidates for the next stages of the hiring process.
...
status_group: This column categorizes the applications into two groups: 'Rejected' and 'Approved'. We display 'Rejected' at first. The categorization is based on the value of the application_status column in the applications table:
